...
const HeaderMenu = props => {
    return (
        <>
            <section className="cvvc-header-menu sc-kgoBCf fZMEGE">
                <div>
                    <menu className="menu-deslogado sc-cHGsZl jmPZmE" data-context="header_menu">
                        ...
                        <div className="menuitem sc-TOsTZ efGrHD"><a
                            ...
                            data-item="000AJUDA E SUPORTE" font-size="0.875rem" width="100%">AJUDA E
                                        SUPORTE<span className="caret sc-VigVT cgiFkg"><svg viewBox="0 0 320 512">
                                <path
                        ...
                        <div className="menuitem sc-TOsTZ nHnaK"><a
                            className="btn-menu  tem-submenu vantagens sc-bwzfXH iaXBsB" href="#"
                            data-item="000+ VANTAGENS" font-size="0.875rem" width="100%">+ VANTAGENS<span
                                className="caret sc-VigVT cgiFkg"><svg viewBox="0 0 320 512">
                                    <path
                                        d="M31.3 192h257.3c17.8 0 26.7 21.5 14.1 34.1L174.1 354.8c-7.8 7.8-20.5 7.8-28.3 0L17.2 226.1C4.6 213.5 13.5 192 31.3 192z">
                                    </path>
                                </svg></span></a>
                                ...
                                <div className="col sc-jTzLTM imJzZn">
                                    ...
                                    <div><a className="button-menu sc-bwzfXH iaXBsB" target="_blank"
                                        href="https://oiwifi.com.br/" font-size="0.875rem" width="100%">Oi
                                                    Wifi</a></div>
                                    <div><a className="button-menu sc-bwzfXH iaXBsB" href="https://www.vvcplay.tv/"
                                        font-size="0.875rem" width="100%">VVC Play</a></div>
                                </div>
                            </div>
                        </div>
                    </menu>
