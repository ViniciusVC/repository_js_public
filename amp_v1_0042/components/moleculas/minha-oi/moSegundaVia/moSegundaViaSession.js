      ...
      <>
          <div className="segundaviaDivlinha">
              <div>
                  ...
                  <BtLink href="https://www.vvc.com.br/minha-oi/codigo-de-barras/" value="Acessar conta" estilo="laraja-degrade"/>
                  <p className="segundaViaP" >
                    <span>Pra acessar sua conta detalhada e os serviços Oi TV e Fibra, </span>
                  </p>
                  <Link href="https://login.vvc.com.br/nidp/app/login?id=loginsegurancasso&sid=10&option=credential&sid=10" value="entre na Minha VVC" estilo="Link2"/>
              </div>
