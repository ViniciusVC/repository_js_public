	...
	return (
		<div className="moAtendimentoSession3">
			<ol className="listaUteis">
				<li>
					<a href="https://www.vvc.com.br/faq/p/como-consigo-a-2via-da-minha-conta">
						Como consigo a 2ª via da minha conta?
						<Icon type="caret" color="#D82482" width="8px" />
					</a>
				</li>
				<li>
					<a href="https://www.vvc.com.br/faq/p/como-religar-um-servico-bloqueado">
						Como religar um serviço bloqueado?
						<Icon type="caret" color="#D82482" width="8px" />
					</a>
				</li>
				<li>
					<a href="https://www.vvc.com.br/faq/p/como-resolver-problemas-tecnicos-de-fixo-e-banda-larga-da-oi">
						Como resolver problemas técnicos de fixo e banda larga da Oi?
						<Icon type="caret" color="#D82482" width="8px" />
					</a>
				</li>
				<li>
					<a href="https://www.vvc.com.br/faq/p/como-recarrego-um-celular-pre-pago-pelo-aplicativo-minha-oi">
						Como recarrego um celular Pré-pago pelo aplicativo Minha VVC?
						<Icon type="caret" color="#D82482" width="8px" />
					</a>
				</li>
				<li>
					<a href="https://www.vvc.com.br/faq/p/como-bloqueio-meu-celular-ou-minimodem-por-perda-ou-roubo">
