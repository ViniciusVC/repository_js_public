        ...
        <section className="fZMEGE">
            <div>
                <nav className="jmPZmE">
                    <div className="ixAXz">
                        <a className="btn-menu sem-submenu iaXBsB" href="https://www.vvc.com.br/minha-oi/">
                            INÍCIO
                        </a>
                    </div>
                    <div className="cMkdVA">
                        <a className="btn-menu sem-submenu iaXBsB" href="https://minha.vvc.com.br/codigo-de-barras/">
                            CONTAS E PAGAMENTOS
                        </a>
                    </div>
                    ...
                    <div className="bhQqYh">
                        <a className="btn-menu sem-submenu iaXBsB" href="https://www.vvc.com.br/recarga/">  
                            RECARGA
                        </a>
                    </div>
                    ...
                    <div className="col imJzZn">
                        <div>
                            <a className="button-menu iaXBsB" href="https://www.vvc.com.br/oi/vvc-pra-voce/planos-servicos/vvc-pontos/">
                                Oi Pontos
                            </a>
                        </div>
                        <div>
