...
class Index extends React.Component {
  render() {
    console.log('Rodando /views/organisms/Head02.jsx  - layout Portal Oi VIGNETTE');
    return (
      <head>
        <title>Cobertura 4G: planos com internet móvel no seu telefone</title>
        ...
        <link rel="stylesheet" href="/ArquivosEstaticos/oi/style/b2c.css" type="text/css" media="screen" />
        <link rel="stylesheet" href="/ArquivosEstaticos/oi/style/sidebar.css" type="text/css" media="screen" />
        <link rel="stylesheet" href="/ArquivosEstaticos/oi/style/base.css" type="text/css" media="screen" />
        ...
        <script src="/ArquivosEstaticos/oi/scripts/jquery.js" type="text/javascript"></script>
        <script src="/ArquivosEstaticos/oi/scripts/jquery.selectbox-0.5.js" type="text/javascript"></script>
        <script src="/ArquivosEstaticos/oi/scripts/jquery.autobox.js" type="text/javascript"></script>
        <script src="/ArquivosEstaticos/oi/scripts/sidebar.js" type="text/javascript"></script>
        <script src="/ArquivosEstaticos/oi/scripts/functions.js?1" type="text/javascript"></script>
        <script src="/ArquivosEstaticos/oi/scripts/menu.js" type="text/javascript"></script>
        <script src="/ArquivosEstaticos/Institucional/js/jquery.cookie.js" type="text/javascript"></script>
        <script src="/ArquivosEstaticos/Institucional/js/modal_regionalizacao.js" type="text/javascript"></script>
        <script type="text/javascript">isIE6 = false;</script>
        <script src="/ArquivosEstaticos/oi/scripts/html5.js" type="text/javascript"></script>
        <script src="/ArquivosEstaticos/oi/scripts/functions-ie.js" type="text/javascript"></script>
        <script type="text/javascript" src="/ArquivosEstaticos/oi/scripts/iepngfix/iepngfix_tilebg.js"></script>
