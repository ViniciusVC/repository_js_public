...
// import NavFooter01 from './NavFooter01.js';
// import Recaptcha from '../components/organisms/seo/footer01'

const RefionFooter01 = function(props){
  var cidade = "Rio de Janeiro";
  if(props.cidade!=undefined){
    cidade = props.cidade
  }
  console.log('Rodando /views/organisms/refionFooter01.jsx - layout Portal Oi SEO');
  return(
    <div class="footer-regionalization">
      ...
      <div classname="regionFooter01div">
        <h3 className="regionFooter01H3">Regionalization</h3>
        <a className="regionFooter01a">
          <span>{cidade}</span>
          <span className="regionFooter01icon">
    ...
    <style jsx>{`
      ...
      .regionFooter01a{border-bottom-left-radius: 1.44px;
