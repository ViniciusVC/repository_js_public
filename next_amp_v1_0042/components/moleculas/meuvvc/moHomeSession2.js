...
const moHomeSession2 = props => {
    ...
    return (
        <div className="moHomeSession2">
            <div>
                <Img
                        src="https://www.vvcestudio.com.br/meuvvc/assets/images/notebook-internet.jpg"
                        width="600px"
                        height="400px"
            ...
            <div>
                ...
                <BtLink href="http://vvcestudio.com.br/lp/clientebl-aumente-bandalarga?origem=minhavvc30_prelogin&pagina=clientebl-aumente-bandalarga" value="Veja a disponibilidade" estilo="amarelo1"/>
